...
setEPS()
pdf(paste0(wd,"Figures/FigSM_boot_perm.pdf"), height=11, width=11)
{


par(mfrow=c(2,2), cex.lab=1.5)
plot(mean_perm~mean_boot,all, pch=pch, cex=cex, col=col, main="Posterior Mean", xlab="Parametric Bootstrap", ylab="Permutation")
abline(0,1, col="red")
text(0.1,0.9,paste0("r=",round(cor(all[,"mean_boot"],all[,"mean_perm"]),3)), cex=1.5)

plot(median_perm~median_boot,all, pch=pch, cex=cex, col=col, main="Posterior Median", xlab="Parametric Bootstrap", ylab="Permutation")
abline(0,1, col="red")
text(0.1,0.9,paste0("r=",round(cor(all[,"median_boot"],all[,"median_perm"]),3)), cex=1.5)

plot(mode1_perm~mode1_boot,all, pch=pch, cex=cex, col=col, main="Posterior Mode (adjust=1)", xlab="Parametric Bootstrap", ylab="Permutation")
abline(0,1, col="red")
text(0.1,0.9,paste0("r=",round(cor(all[,"mode1_boot"],all[,"mode1_perm"]),3)), cex=1.5)

plot(mode0.1_perm~mode0.1_boot,all, pch=pch, cex=cex, col=col, main="Posterior Mode (adjust=0.1)", xlab="Parametric Bootstrap", ylab="Permutation")
abline(0,1, col="red")
...
plot(mean_boot~median_boot,all, pch=pch, cex=cex, col=col, xlab="Median",ylab="Mean", main="Bootstrap")
abline(0,1, col="red")
...
plot(mean_boot~mode1_boot,all, pch=pch, cex=cex, col=col, xlab="Mode-1",ylab="Mean", main="Bootstrap")
abline(0,1, col="red")
...
plot(mean_boot~mode0.1_boot,all, pch=pch, cex=cex, col=col, xlab="Mode-0.1",ylab="Mean", main="Bootstrap")
abline(0,1, col="red")
...
plot(mode1_boot~mode0.1_boot,all, pch=pch, cex=cex, col=col, xlab="Mode-0.1",ylab="Mode-1", main="Bootstrap")#col=alpha(1:4,0.3)[as.factor(all$N_group)])
abline(0,1, col="red")
