...
p_long_alt <- Stack(p_alt,c("mean","median","mode","freq","LRT"), group.name="type",value.name = "estimate")
p_long_null <- Stack(p_null,c("mean","median","mode","freq","LRT"), group.name="type",value.name = "estimate")
...
beeswarm(estimate~sim_var+type,long, pch=19, cex=0.5, col=alpha(1,0.3),method = "compactswarm",corral="wrap",xlab="Estimate Type", ylab="Estimate")#, labels=c("ML","Posterior Mean","Posterior Median","Posterior Mode"))
...
# beeswarm(estimate~sim_var+type,p_long, pch=19, cex=0.5, col=alpha(1,0.3),method = "compactswarm",corral="wrap",xlab="Estimate Type", ylab="Estimate")#, labels=c("ML","Posterior Mean","Posterior Median","Posterior Mode"))
boxplot(estimate~sim_var+type,p_long, pch=19, cex=0.5, col=alpha(1,0.3),method = "compactswarm",corral="wrap",xlab="Estimate Type", ylab="Estimate")#, 
